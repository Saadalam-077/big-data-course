    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900/30 to-slate-900 flex items-center justify-center p-4">
      <div className="bg-slate-800/50 backdrop-blur rounded-2xl p-8 w-full max-w-md border border-slate-700">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-white">Big Data</h1>
          <p className="text-purple-300/70 font-arabic">البيانات الضخمة</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button type="submit" disabled={loading} className="w-full py-3 bg-purple-600 hover:bg-purple-500 text-white font-bold rounded-lg transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2">
            {loading ? (
              <>
        ...
        <p className="text-center text-slate-400 mt-6">
          ...
          <button onClick={() => onNavigate('register')} className="text-purple-400 hover:underline">Register</button>
        </p>
      </div>
    </div>
  );
