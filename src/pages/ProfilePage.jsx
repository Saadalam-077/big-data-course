...
const ProfilePage = ({ user, onNavigate, onLogout }) => {
  const labs = [
    { lab: 1, title: "Introduction to Big Data" },
    { lab: 2, title: "Big Data Characteristics (5 V's)" },
    { lab: 3, title: "Hadoop Ecosystem" },
    { lab: 4, title: "HDFS - Hadoop File System" },
    { lab: 5, title: "MapReduce Fundamentals" },
    { lab: 6, title: "Introduction to Apache Spark" },
    { lab: 7, title: "Spark RDDs and DataFrames" },
    { lab: 8, title: "NoSQL Databases" },
    { lab: 9, title: "Data Visualization" },
    { lab: 10, title: "Big Data Project" },
  ];
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-700 mb-8">
          <div className="flex items-center gap-4">
            <div className="w-16 h-16 bg-purple-600 rounded-full flex items-center justify-center text-2xl text-white font-bold">{user.studentName.charAt(0)}</div>
            <div>
        ...
        <div className="mt-8 bg-slate-800/50 rounded-2xl p-6 border border-slate-700">
          ...
          <div className="grid grid-cols-5 gap-2 text-center text-sm">
            ...
            <div className="bg-purple-900/30 rounded-lg p-2"><span className="text-purple-400 font-bold">B+</span><p className="text-slate-400">80-84%</p></div>
            <div className="bg-purple-900/20 rounded-lg p-2"><span className="text-purple-300 font-bold">B</span><p className="text-slate-400">75-79%</p></div>
